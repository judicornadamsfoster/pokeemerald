...
// Debug options
#define TX_DEBUG_SYSTEM_ENABLE         TRUE               // Enables a overworld debug menu for changing flags, variables, giving pokemon and more, accessed by holding L & R and pressing START while in the overworld by default.
#define TX_DEBUG_SYSTEM_HELD_KEYS      (L_BUTTON) && (R_BUTTON)         // The keys required to be held to open the debug menu.
